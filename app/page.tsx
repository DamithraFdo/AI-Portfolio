...
function GallerySection() {
  ...
  const categories = [
    ...
    { id: 'character', label: 'Character sheets', icon: ImageIcon },
  ...
  const artworks = [
    ...
    { title: "Old photo restoration", category: "Restore", image: "/images/gallery/image11.png", prompt: "Restore this old photo into professional portrait of DLSR-quality colour and detail, using an advanced upscaling algorithm comparable to the results from canon EOS R6 II. Ensure the restored the image looks natural, retains exact facial features, has great clarity." },
    { title: "Character Sheet", category: "character", image: "/images/gallery/image12.jpeg", prompt: "Create a professional AI character turnaround sheet based on the uploaded reference photo. The highest priority is identity preservation and facial accuracy. Preserve the exact facial structure, jawline, cheekbone proportions, chin shape, smile, beard pattern, nose shape, eye spacing, eyebrow shape, forehead proportions, hairstyle, hairline, skin tone, and overall likeness from the reference image. Do NOT stylize, beautify, sharpen, slim, or alter the face in any way. Maintain the same natural masculine appearance and authentic proportions. Create a professional full-body character turnaround and anatomy pose sheet based entirely on the uploaded reference image. The absolute highest priority is preserving the exact identity and facial structure from the reference photo." },
    { title: "Concept character", category: "character", image: "/images/gallery/image13.jpeg", prompt: "Cute mythical animal character sheet, Studio Ghibli-inspired fantasy creature design, full-body turnaround sheet with front view, side view, back view, and 3/4 perspective, multiple facial expressions, different poses, walking and sitting poses, detailed accessory close-ups, soft fluffy textures, magical glowing elements, charming anime aesthetic, hand-painted watercolor style, warm fantasy color palette, clean presentation layout on light parchment background, highly detailed concept art, professional animation model sheet, whimsical fantasy atmosphere, expressive eyes, tiny horns, feathered tail and wings, natural forest-inspired design, cinematic lighting, adorable mascot creature, Hayao Miyazaki-inspired art direction, high detail, polished illustration, animation studio quality, 4k concept sheet, organized design notes and proportions, magical creature reference board" },
  ]
...
function ThumbnailSection() {
  ...
  const thumbnails = [
    ...
    { title: "The Ten Giant", views: "890K", channel: "Strydo Studios", image: "/images/thumbnails/thumb2.jpg", prompt: "Cinematic ultra-realistic landscape animation in 4K, epic game intro / teaser style, featuring the legendary Sri Lankan Dasamaha Yodayo (Ten Giant Warriors) in intense battle.Dramatic twilight scene on an ancient battlefield near a massive stone fortress surrounded by lush jungle. Iconic warriors in authentic traditional Sri Lankan armor: Pussadeva powerfully blowing the conch shell, Nandimithra charging forward with a spear, and Mahasona towering with immense strength. Dynamic combat choreography with clashing swords and spears, war elephants, flying arrows, dust clouds, flaming torches, and heroic action poses.Sweeping wide cinematic shots mixed with intense close-ups of duels and slow-motion strikes. Ultra-realistic details: sweat on skin, cracked and battle-worn armor, glowing fire reflections, dramatic volumetric lighting, god rays, and epic atmosphere. Thunderous mythic feel with heroic grandeur and rich Sri Lankan cultural authenticity.Text elements:- Large, bold, central title 'TEN GIANT WARRIORS' in powerful epic game-style font at the top center- Small watermark in top right corner: 'Damithra' in clean white text and 'Fdo' in blue text, elegant and subtle- Bottom credit in small elegant font: 'Strydo Labs All Rights Reserved 2026'Landscape orientation, ultra-detailed textures, cinematic color grading, dramatic lighting, mythic and heroic mood, masterpiece quality." },
...
function VideoSection() {
  ...
  const videos = [
    { 
      title: "Rajarata Ruins", 
      description: "AI-generated cinematic commercial showcasing ancient Sri Lankan archaeological sites with dynamic camera movements and atmospheric effects",
      duration: "0:45",
      type: "Story",
      video: "/images/videos/video1.mp4",
      prompt: "ultra realistic cinematic film still, sri lankan post apocalyptic atmosphere, tropical humidity, grounded realism, emotional mood, anamorphic lens, shallow depth of field, volumetric fog, film grain, moody lighting, realistic textures. sri lankan man, mid 20s, curly short black hair, medium muscular body, brown skin, slight beard, expressive tired eyes, realistic face, rugged survivor aesthetic, dark faded hoodie, cargo pants, survival backpack, cinematic realism"
    },
    { 
      title: "Mythical Journey", 
      description: "A whimsical mythical creature",
      duration: "3:24",
      type: "Ghibli Style Animation",
      video: "/images/videos/video2.mp4",
      prompt: "A whimsical mythical creature, ultra cute and magical, inspired by classic Studio Ghibli fantasy worlds, soft fluffy fur, glowing expressive eyes, tiny horns and feathered wings, floating gently in an enchanted forest, warm sunset lighting filtering through giant trees, cozy fantasy atmosphere, hand-painted anime aesthetic, highly detailed textures, vibrant yet soft natural colors, cinematic composition, dreamy particles in the air, charming and emotional mood, gentle smile, fantasy spirit companion design, magical realism, lush moss, flowers and fireflies surrounding the creature, watercolor-style shading, peaceful adventure vibe, Hayao Miyazaki-inspired fantasy art, high detail, 4k illustration, adorable mythical animal character, storybook feeling, masterpiece quality --ar 16:9"
    },
    { 
